...
class CI_Smarty extends Smarty {
    ...
    public function __construct()
    {
        ...
        //注册smarty的插件函数
        Smarty::registerPlugin("function","site_url", array(&$this, 'site_url'));
        Smarty::registerPlugin("function","base_url", array(&$this, 'base_url'));
    ...
    /**
     * 在smarty内使用site_url函数
     * @param  [type] $params [description]
     * @return [type]         [description]
     */
    public function site_url($params){
        extract($params);
        $CI =& get_instance();
        $CI->load->helper('url');
    ...
    /**
     * 在smarty内使用base_url函数
     * @param  [type] $params [description]
     * @return [type]         [description]
     */
    public function base_url($params){
        extract($params);
        $CI =& get_instance();
        $CI->load->helper('url');
